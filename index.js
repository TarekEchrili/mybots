...
❇️ عدد المبيعات : ${coinPi.info.normal.sales}
⭐️ التقييم من 5 : ${coinPi.info.normal.rate}

<b>----------- | ✨ التخفيضات ✨ | -----------</b>

🌟رابط تخفيض النقاط:  Dz ${parseInt(coinPi.info.points.discountPrice.replace("US $", "") * 229)} / ${coinPi.info.points.discountPrice}
${coinPi.aff.points}

🔥 رابط تخفيض السوبر: Dz ${parseInt(coinPi.info.super.price.replace("US $", "") * 229)} / ${coinPi.info.super.price}
${coinPi.aff.super}

📌رابط العرض المحدود: Dz ${parseInt(coinPi.info.limited.price.replace("US $", "") * 229)} / ${coinPi.info.limited.price}
${coinPi.aff.limited}
<b>----------- | ✨ الكوبونات ✨ | -----------</b>
${couponList}
` ,
